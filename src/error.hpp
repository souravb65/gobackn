...
<header id="source-path">
  ...
  <div class="secondary-actions">
    <div class="aui-buttons">
        ...
        <a href="/souravb65/gobackn/src/becf44494a1b/src/error.hpp?at=master"
           class="aui-button pjax-trigger" aria-pressed="true">
          Source
        </a>
        <a href="/souravb65/gobackn/diff/src/error.hpp?diff2=becf44494a1b&at=master"
           class="aui-button pjax-trigger"
           title="Diff to previous change">
          Diff
        </a>
        <a href="/souravb65/gobackn/history-node/becf44494a1b/src/error.hpp?at=master"
           class="aui-button pjax-trigger">
          History
        </a>
  ...
  <h1>
        ...
        <a href="/souravb65/gobackn/src/becf44494a1b?at=master"
          class="pjax-trigger root" title="souravb65/gobackn at becf44494a1b">GoBackN</a> /
            ...
            <span class="file-name">error.hpp</span>
  ...
  <div id="editor-container" class="maskable"
       ...
       data-branch="master"
       data-path="src/error.hpp"
       data-source-url="/api/internal/repositories/souravb65/gobackn/src/becf44494a1bd0a35f9b3d005acbf9042a160206/src/error.hpp">
  ...
  <span class="aui-icon-dropdown"></span>
          ...
          <a href="/souravb65/gobackn/full-commit/becf44494a1b/src/error.hpp" id="full-commit-link"
        ...
        <div class="secondary">
          ...
          <div class="aui-buttons">
              ...
              <a href="/souravb65/gobackn/annotate/becf44494a1bd0a35f9b3d005acbf9042a160206/src/error.hpp?at=master"
                 class="aui-button aui-button-light pjax-trigger">Blame</a>
              
            
            <a href="/souravb65/gobackn/raw/becf44494a1bd0a35f9b3d005acbf9042a160206/src/error.hpp" class="aui-button aui-button-light">Raw</a>
          </div>
    ...
    <div class="file-source">
      <table class="codehilite highlighttable"><tr><td class="linenos"><div class="linenodiv"><pre><a href="#error.hpp-1"> 1</a>
<a href="#error.hpp-2"> 2</a>
<a href="#error.hpp-3"> 3</a>
<a href="#error.hpp-4"> 4</a>
<a href="#error.hpp-5"> 5</a>
<a href="#error.hpp-6"> 6</a>
<a href="#error.hpp-7"> 7</a>
<a href="#error.hpp-8"> 8</a>
<a href="#error.hpp-9"> 9</a>
<a href="#error.hpp-10">10</a>
<a href="#error.hpp-11">11</a>
<a href="#error.hpp-12">12</a>
<a href="#error.hpp-13">13</a>
<a href="#error.hpp-14">14</a>
<a href="#error.hpp-15">15</a></pre></div></td><td class="code"><div class="codehilite highlight"><pre><span></span><a name="error.hpp-1"></a><span class="cm">/*</span>
<a name="error.hpp-2"></a><span class="cm"> * error.hpp</span>
<a name="error.hpp-3"></a><span class="cm"> *</span>
<a name="error.hpp-4"></a><span class="cm"> *  Created on: 20-Aug-2016</span>
<a name="error.hpp-5"></a><span class="cm"> *      Author: sourav</span>
<a name="error.hpp-6"></a><span class="cm"> */</span>
<a name="error.hpp-7"></a>
<a name="error.hpp-8"></a><span class="cp">#ifndef SRC_ERROR_HPP_</span>
<a name="error.hpp-9"></a><span class="cp">#define SRC_ERROR_HPP_</span>
<a name="error.hpp-10"></a>
<a name="error.hpp-11"></a>
<a name="error.hpp-12"></a>
<a name="error.hpp-13"></a>
<a name="error.hpp-14"></a>
<a name="error.hpp-15"></a><span class="cp">#endif </span><span class="cm">/* SRC_ERROR_HPP_ */</span><span class="cp"></span>
</pre></div>
</td></tr></table>
    </div>
    ...
    <div class="tab-pane active-pane" id="branches" data-filter-placeholder="Filter branches">
      <ol class="filter-list">
        ...
        [[#branches]]
            ...
            [[#hasMultipleHeads]]
              [[#heads]]
                <li class="comprev filter-item">
                  <a class="pjax-trigger filter-item-link" href="/souravb65/gobackn/src/[[changeset]]/src/error.hpp?at=[[safeName]]"
                     title="[[name]]">
                    [[name]] ([[shortChangeset]])
                  </a>
                </li>
            ...
            [[^hasMultipleHeads]]
              <li class="comprev filter-item">
                <a class="pjax-trigger filter-item-link" href="/souravb65/gobackn/src/[[changeset]]/src/error.hpp?at=[[safeName]]" title="[[name]]">
                  [[name]]
                </a>
              </li>
            [[/hasMultipleHeads]]
...
<script type="text/javascript">window.NREUM||(NREUM={});NREUM.info={"beacon":"bam.nr-data.net","queueTime":0,"licenseKey":"a2cef8c3d3","agent":"","transactionName":"Z11RZxdWW0cEVkYLDV4XdUYLVEFdClsdAAtEWkZQDlJBGgRFQhFMQl1DXFcZQ10AQkFYBFlUVlEXWEJHAA==","applicationID":"1841284","errorBeacon":"bam.nr-data.net","applicationTime":203}</script>
</body>
</html>